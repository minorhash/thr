...
var textureLoader = new THREE.TextureLoader();
    ...
    this.particleNoiseTex = this.PARTICLE_NOISE_TEXTURE || textureLoader.load( 'img/par/perlin-512.png' );
this.particleNoiseTex.wrapS = this.particleNoiseTex.wrapT = THREE.RepeatWrapping;

    this.particleSpriteTex = this.PARTICLE_SPRITE_TEXTURE || textureLoader.load( 'img/par/particle2.png' );
